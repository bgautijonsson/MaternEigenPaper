...
Similarly to @rue2005a, this paper proposes a way to efficiently calculate the marginal variances in GMRFs, but instead of working with the Cholesky decomposition of any general GMRF precision matrix, we focus specifically on the sparse approximation to the Gaussian field with Matérn coveriance as defined in @lindgren2011:
